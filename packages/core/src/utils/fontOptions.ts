...
export const EXTENDED_FONTS: FontOption[] = [
  ...
  { name: '仿宋_GB2312', fontFamily: '"仿宋_GB2312", FangSong, 仿宋, serif', category: 'serif' },
  {
    name: '方正仿宋简体',
    fontFamily: '"方正仿宋简体", "仿宋_GB2312", FangSong, serif',
    category: 'serif',
  },
  {
    name: '方正小标宋简体',
    fontFamily: '"方正小标宋简体", "方正小标宋_GBK", SimSun, 宋体, serif',
    category: 'serif',
  },
